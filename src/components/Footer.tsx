        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-300">
              <li className="flex items-start">
                ...
                <span>123 Aviation Way, Melbourne Airport, VIC 3045</span>
              </li>
              <li className="flex items-center">
                <svg className="h-6 w-6 text-sky-400 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <li className="flex items-center">
                ...
                <span>info@melbourneflightacademy.com</span>
              </li>
              <li className="flex items-center">
                <svg className="h-6 w-6 text-sky-400 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              ...
              <li><a href="#courses" className="hover:text-sky-400 transition-colors">Flight Courses</a></li>
              <li><a href="#fleet" className="hover:text-sky-400 transition-colors">Our Fleet</a></li>
              <li><a href="#instructors" className="hover:text-sky-400 transition-colors">Instructors</a></li>
          ...
          <div>
            ...
            <p className="text-gray-300 mb-4">Subscribe to our newsletter for the latest updates and aviation insights.</p>
            <form className="flex flex-col space-y-2">
              <input 
                type="email" 
                placeholder="Your email address" 
                className="px-4 py-2 bg-navy-800 border border-navy-700 text-white rounded focus:outline-none focus:ring-2 focus:ring-sky-400"
              />
              <button 
                type="submit" 
